    ...
    return (
        <div className="hidden md:block w-1/6 bg-black p-4 space-y-4 border border-gray-800">
            <nav className="bg-black text-white space-y-4 ">
                ...
                <div className="hover-line flex justify-center font-bold"><Link href="/resumeTemplate">
                    Templates
                </Link></div>
                ...
                <div className="hover-line flex justify-center hover:decoration-emerald-300 cursor-move"><Link href="/skills">
                    Skills
                </Link></div>
                <div className="hover-line flex justify-center hover:decoration-emerald-300 cursor-move"><Link href="/awards">
                    Awards
                </Link></div>
                <div className="hover-line flex justify-center hover:decoration-emerald-300 cursor-move"><Link href="/projects">
                    Projects
                </Link>
                </div>
                {/* </ul> */}
