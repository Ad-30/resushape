                        ...
                        {templates.map((template) => (
                            <div key={template.id} className='py-2 px-2 '>
                                <Image
                                    ...
                                    width={325}
                                    height={500}
                                    onClick={() => handleImageClick(template.src)}
                                />
                                <div className='flex items-center justify-center mx-auto py-3'>
                                    <Button className='border border-gray-600 hover:border-emerald-400 hover:text-emerald-400 bg:transparent text-white'>
                                        {template.buttonText}
                                    </Button>
                                </div>
                            </div>
