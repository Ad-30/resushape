...
const DashboardLayout = ({ children }: { children: React.ReactNode; }) => {
    ...
    const getInitialData = () => {
        ...
        const initialTemplate: Number = parsedTemplateData?.selectedTemplate
            ? parsedTemplateData.selectedTemplate
            : savedTemplateData.selectedTemplate
                ? savedTemplateData.selectedTemplate
                : defaultTemplateData.selectedTemplate;
    ...
    return (
        <ResumeContext.Provider
            value={{
                resumeURL, setResumeURL, isResumeLoading, setIsResumeLoading, profileData, setProfileData, selectedTemplate, setSelectedTemplate, educationData, setEducationData, workData, setWorkData, skillsData, setSkillsData, projectData, setProjectData, awardsData, setAwardsData
            }}
        >
